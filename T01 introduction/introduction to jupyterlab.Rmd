...
- Install the package **"IRkernel"** (in R/Rstudio) by any means;
    - You can use "devtools::install_github('IRkernel/IRkernel')" or "install.packages("IRkernel")";

- Run R in **Anaconda Prompt** (for windows users) or **terminal** (for mac users), and carry out **"IRkernel::installspec()"**.
